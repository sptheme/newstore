...
if ( ! class_exists( 'WPSP_Image_Resize' ) ) {

	class WPSP_Image_Resize {
		...
		public function process( $args ) {
			...
			if ( $crop && wpsp_get_redux( 'is-image-resizing', true ) ) {
				if ( is_array( $crop ) ) {
...
// Helper function for resizing images using the WPSP_Image_Resize class
if ( ! function_exists( 'wpsp_image_resize' ) ) {
	function wpsp_image_resize( $args ) {
		$class = new WPSP_Image_Resize;
