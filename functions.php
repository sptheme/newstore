...
function newstore_setup() {
	 ...
	 * If you're building a theme based on newstore, use a find and replace
...
function newstore_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'newstore_content_width', 640 );
}
...
function newstore_widgets_init() {
	register_sidebar( array(
		...
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'newstore' ),
...
function newstore_scripts() {
	...
	wp_enqueue_script( 'newstore-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'newstore-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
